...
exports.PublishType = exports.PublishChannel = exports.FormType = exports.TimeUnit = exports.PLATFORM_RULES = void 0;
exports.getPlatformRule = getPlatformRule;
exports.getAllPlatforms = getAllPlatforms;
exports.buildContentPublishForm = buildContentPublishForm;
exports.buildPlatformPublishForm = buildPlatformPublishForm;
exports.validatePublishParams = validatePublishParams;
...
})(PublishChannel || (exports.PublishChannel = PublishChannel = {}));
var PublishType;
...
function getPlatformRule(platformCode) {
    return exports.PLATFORM_RULES[platformCode];
}
function getAllPlatforms() {
    return Object.values(exports.PLATFORM_RULES);
}
...
function buildPlatformPublishForm(publishType, platformCode, params) {
    const rule = getPlatformRule(platformCode);
    if (!rule)
        return {};
    return buildContentPublishForm(publishType, params);
}
function validatePublishParams(platformCode, publishType) {
    const rule = getPlatformRule(platformCode);
    if (!rule) {
