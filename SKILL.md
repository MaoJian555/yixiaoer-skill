...
>
> ```bash
> npx clawhub install yixiaoer-skill
> ```
>
> **不要使用**：`npx clawhub install MaoJian555/yixiaoer-skill`（这是错误的格式）
>
> **下载地址**：https://github.com/MaoJian555/yixiaoer-skill
