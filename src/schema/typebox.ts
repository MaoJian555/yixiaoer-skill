...
function jsonSchemaToTypeBox(schema: JsonSchema): TSchema {
  ...
  switch (schema.type) {
    case "string":
      ...
      if (schema.default !== undefined) stringProps.default = schema.default as string;
    ...
    case "number":
      ...
      if (schema.default !== undefined) numberProps.default = schema.default as number;
    ...
    case "array":
      if (schema.items) {
        const itemType = jsonSchemaToTypeBox(schema.items);
...
export { jsonSchemaToTypeBox, JsonSchema };
